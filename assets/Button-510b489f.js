...
`),jr=q({name:"BaseWave",props:{clsPrefix:{type:String,required:!0}},setup(o){Xe("-base-wave",Nr,Pe(o,"clsPrefix"));const s=R(null),a=R(!1);let x=null;return zr(()=>{x!==null&&window.clearTimeout(x)}),{active:a,selfRef:s,play(){x!==null&&(window.clearTimeout(x),a.value=!1,x=null),Ke(()=>{var k;(k=s.value)===null||k===void 0||k.offsetHeight,a.value=!0,x=window.setTimeout(()=>{a.value=!1,x=null},1e3)})}}},render(){const{clsPrefix:o}=this;return n("div",{ref:"selfRef","aria-hidden":!0,class:[`${o}-base-wave`,this.active&&`${o}-base-wave--active`]})}}),Kr=z("base-clear",`
 flex-shrink: 0;
 height: 1em;
 width: 1em;
 position: relative;
`,[g(">",[i("clear",`
 ...
 `,[no({originalTransform:"translateX(-50%) translateY(-50%)",left:"50%",top:"50%"})])])]),qe=q({name:"BaseClear",props:{clsPrefix:{type:String,required:!0},show:Boolean,onClear:Function},setup(o){return Xe("-base-clear",Kr,Pe(o,"clsPrefix")),{handleMouseDown(s){var a;s.preventDefault(),(a=o.onClear)===null||a===void 0||a.call(o,s)}}},render(){const{clsPrefix:o}=this;return n("div",{class:`${o}-base-clear`},n(ao,null,{default:()=>{var s,a;return this.show?n("div",{key:"dismiss",class:`${o}-base-clear__clear`,onClick:this.onClear,onMousedown:this.handleMouseDown,"data-clear":!0},xe(this.$slots.icon,()=>[n(Re,{clsPrefix:o},{default:()=>n(Hr,null)})])):n("div",{key:"icon",class:`${o}-base-clear__placeholder`},(a=(s=this.$slots).placeholder)===null||a===void 0?void 0:a.call(s))}}))}}),Ur=q({name:"InternalSelectionSuffix",props:{clsPrefix:{type:String,required:!0},showArrow:{type:Boolean,default:void 0},showClear:{type:Boolean,default:void 0},loading:{type:Boolean,default:!1},onClear:Function},setup(o,{slots:s}){return()=>{const{clsPrefix:a}=o;return n(io,{clsPrefix:a,class:`${a}-base-suffix`,strokeWidth:24,scale:.85,show:o.loading},{default:()=>o.showArrow?n(qe,{clsPrefix:a,show:o.showClear,onClear:o.onClear},{placeholder:()=>n(Re,{clsPrefix:a,class:`${a}-base-suffix__arrow`},{default:()=>xe(s.default,()=>[n(Or,null)])})}):null})}}}),{cubicBezierEaseInOut:Y}=Sr;function Gr({duration:o=".2s",delay:s=".1s"}={}){return[g("&.fade-in-width-expand-transition-leave-from, &.fade-in-width-expand-transition-enter-to",{opacity:1}),g("&.fade-in-width-expand-transition-leave-to, &.fade-in-width-expand-transition-enter-from",`
 opacity: 0!important;
 ...
 margin-left ${o} ${Y},
 margin-right ${o} ${Y};
 `)]}const qr=ke&&"chrome"in window;ke&&navigator.userAgent.includes("Firefox");const po=ke&&navigator.userAgent.includes("Safari")&&!qr,bo=lo("n-input");function Xr(o){let s=0;for(const a of o)s++;return s}function $e(o){return o===""||o==null}function Yr(o){const s=R(null);function a(){const{value:P}=o;if(!P?.focus){k();return}const{selectionStart:b,selectionEnd:d,value:v}=P;if(b==null||d==null){k();return}s.value={start:b,end:d,beforeText:v.slice(0,b),afterText:v.slice(d)}}function x(){var P;const{value:b}=s,{value:d}=o;if(!b||!d)return;const{value:v}=d,{start:h,beforeText:u,afterText:S}=b;let F=v.length;if(v.endsWith(S))F=v.length-S.length;else if(v.startsWith(u))F=u.length;else{const j=u[h-1],I=v.indexOf(j,h-1);I!==-1&&(F=I+1)}(P=d.setSelectionRange)===null||P===void 0||P.call(d,F,F)}function k(){s.value=null}return Ue(o,k),{recordCursor:a,restoreCursor:x}}const to=q({name:"InputWordCount",setup(o,{slots:s}){const{mergedValueRef:a,maxlengthRef:x,mergedClsPrefixRef:k,countGraphemesRef:P}=so(bo),b=V(()=>{const{value:d}=a;return d===null||Array.isArray(d)?0:(P.value||Xr)(d)});return()=>{const{value:d}=x,{value:v}=a;return n("span",{class:`${k.value}-input-word-count`},$r(s.default,{value:v===null||Array.isArray(v)?"":v},()=>[d===void 0?b.value:`${b.value} / ${d}`]))}}}),Qr=z("input",`
 max-width: 100%;
 cursor: text;
 line-height: 1.5;
 z-index: auto;
...
`)}else{const{value:T}=h;T&&(e?T.textContent=e:T.innerHTML="&nbsp;")}}function Eo(){Ae()}const Qe=R({top:"0"});function Io(e){var r;const{scrollTop:l}=e.target;Qe.value.top=`${-l}px`,(r=I.value)===null||r===void 0||r.syncUnifiedContainer()}let Ce=null;Je(()=>{const{autosize:e,type:r}=o;e&&r==="textarea"?Ce=Ue(W,l=>{!Array.isArray(l)&&l!==Q&&Ne(l)}):Ce?.()});let ze=null;Je(()=>{o.type==="textarea"?ze=Ue(W,e=>{var r;!Array.isArray(e)&&e!==Q&&((r=I.value)===null||r===void 0||r.syncUnifiedContainer())}):ze?.()}),kr(bo,{mergedValueRef:W,maxlengthRef:me,mergedClsPrefixRef:s,countGraphemesRef:Pe(o,"countGraphemes")});const Mo={wrapperElRef:b,inputElRef:u,textareaElRef:d,isCompositing:D,focus:Ye,blur:ko,select:To,deactivate:Fo,activate:_o,scrollTo:Ao},Do=uo("Input",k,s),Ze=V(()=>{const{value:e}=f,{common:{cubicBezierEaseInOut:r},self:{color:l,borderRadius:C,textColor:T,caretColor:y,caretColorError:J,caretColorWarning:ee,textDecorationColor:oe,border:be,borderDisabled:ge,borderHover:je,borderFocus:Vo,placeholderColor:Wo,placeholderColorDisabled:Lo,lineHeightTextarea:Oo,colorDisabled:Ho,colorFocus:No,textColorDisabled:jo,boxShadowFocus:Ko,iconSize:Uo,colorFocusWarning:Go,boxShadowFocusWarning:qo,borderWarning:Xo,borderFocusWarning:Yo,borderHoverWarning:Qo,colorFocusError:Zo,boxShadowFocusError:Jo,borderError:er,borderFocusError:or,borderHoverError:rr,clearSize:tr,clearColor:nr,clearColorHover:ar,clearColorPressed:ir,iconColor:lr,iconColorDisabled:sr,suffixTextColor:cr,countTextColor:dr,countTextColorDisabled:ur,iconColorHover:fr,iconColorPressed:hr,loadingColor:vr,loadingColorError:pr,loadingColorWarning:br,[c("padding",e)]:gr,[c("fontSize",e)]:xr,[c("height",e)]:mr}}=P.value,{left:yr,right:wr}=Er(gr);return{"--n-bezier":r,"--n-count-text-color":dr,"--n-count-text-color-disabled":ur,"--n-color":l,"--n-font-size":xr,"--n-border-radius":C,"--n-height":mr,"--n-padding-left":yr,"--n-padding-right":wr,"--n-text-color":T,"--n-caret-color":y,"--n-text-decoration-color":oe,"--n-border":be,"--n-border-disabled":ge,"--n-border-hover":je,"--n-border-focus":Vo,"--n-placeholder-color":Wo,"--n-placeholder-color-disabled":Lo,"--n-icon-size":Uo,"--n-line-height-textarea":Oo,"--n-color-disabled":Ho,"--n-color-focus":No,"--n-text-color-disabled":jo,"--n-box-shadow-focus":Ko,"--n-loading-color":vr,"--n-caret-color-warning":ee,"--n-color-focus-warning":Go,"--n-box-shadow-focus-warning":qo,"--n-border-warning":Xo,"--n-border-focus-warning":Yo,"--n-border-hover-warning":Qo,"--n-loading-color-warning":br,"--n-caret-color-error":J,"--n-color-focus-error":Zo,"--n-box-shadow-focus-error":Jo,"--n-border-error":er,"--n-border-focus-error":or,"--n-border-hover-error":rr,"--n-loading-color-error":pr,"--n-clear-color":nr,"--n-clear-size":tr,"--n-clear-color-hover":ar,"--n-clear-color-pressed":ir,"--n-icon-color":lr,"--n-icon-color-hover":fr,"--n-icon-color-pressed":hr,"--n-icon-color-disabled":sr,"--n-suffix-text-color":cr}}),de=x?fo("input",V(()=>{const{value:e}=f;return e[0]}),Ze,o):void 0;return Object.assign(Object.assign({},Mo),{wrapperElRef:b,inputElRef:u,inputMirrorElRef:h,inputEl2Ref:S,textareaElRef:d,textareaMirrorElRef:v,textareaScrollbarInstRef:I,rtlEnabled:Do,uncontrolledValue:ne,mergedValue:W,passwordVisible:X,mergedPlaceholder:M,showPlaceholder1:fe,showPlaceholder2:G,mergedFocus:Z,isComposing:D,activated:U,showClearButton:H,mergedSize:f,mergedDisabled:w,textDecorationStyle:he,mergedClsPrefix:s,mergedBordered:a,mergedShowPasswordOn:m,placeholderStyle:Qe,mergedStatus:O,textAreaScrollContainerWidth:N,handleTextAreaScroll:Io,handleCompositionStart:We,handleCompositionEnd:Le,handleInput:se,handleInputBlur:B,handleInputFocus:A,handleWrapperBlur:ce,handleWrapperFocus:go,handleMouseEnter:Co,handleMouseLeave:zo,handleMouseDown:wo,handleChange:xo,handleClick:mo,handleClear:yo,handlePasswordToggleClick:So,handlePasswordToggleMousedown:$o,handleWrapperKeydown:Po,handleWrapperKeyup:Bo,handleTextAreaMirrorResize:Eo,getTextareaScrollContainer:()=>d.value,mergedTheme:P,cssVars:x?void 0:Ze,themeClass:de?.themeClass,onRender:de?.onRender})},render(){var o,s;const{mergedClsPrefix:a,mergedStatus:x,themeClass:k,type:P,countGraphemes:b,onRender:d}=this,v=this.$slots;return d?.(),n("div",{ref:"wrapperElRef",class:[`${a}-input`,k,x&&`${a}-input--${x}-status`,{[`${a}-input--rtl`]:this.rtlEnabled,[`${a}-input--disabled`]:this.mergedDisabled,[`${a}-input--textarea`]:P==="textarea",[`${a}-input--resizable`]:this.resizable&&!this.autosize,[`${a}-input--autosize`]:this.autosize,[`${a}-input--round`]:this.round&&P!=="textarea",[`${a}-input--pair`]:this.pair,[`${a}-input--focus`]:this.mergedFocus,[`${a}-input--stateful`]:this.stateful}],style:this.cssVars,tabindex:!this.mergedDisabled&&this.passivelyActivated&&!this.activated?0:void 0,onFocus:this.handleWrapperFocus,onBlur:this.handleWrapperBlur,onClick:this.handleClick,onMousedown:this.handleMouseDown,onMouseenter:this.handleMouseEnter,onMouseleave:this.handleMouseLeave,onCompositionstart:this.handleCompositionStart,onCompositionend:this.handleCompositionEnd,onKeyup:this.handleWrapperKeyup,onKeydown:this.handleWrapperKeydown},n("div",{class:`${a}-input-wrapper`},ue(v.prefix,h=>h&&n("div",{class:`${a}-input__prefix`},h)),P==="textarea"?n(Tr,{ref:"textareaScrollbarInstRef",class:`${a}-input__textarea`,container:this.getTextareaScrollContainer,triggerDisplayManually:!0,useUnifiedContainer:!0,internalHoistYRail:!0},{default:()=>{var h,u;const{textAreaScrollContainerWidth:S}=this,F={width:this.autosize&&S&&`${S}px`};return n(_r,null,n("textarea",Object.assign({},this.inputProps,{ref:"textareaElRef",class:[`${a}-input__textarea-el`,(h=this.inputProps)===null||h===void 0?void 0:h.class],autofocus:this.autofocus,rows:Number(this.rows),placeholder:this.placeholder,value:this.mergedValue,disabled:this.mergedDisabled,maxlength:b?void 0:this.maxlength,minlength:b?void 0:this.minlength,readonly:this.readonly,tabindex:this.passivelyActivated&&!this.activated?-1:void 0,style:[this.textDecorationStyle[0],(u=this.inputProps)===null||u===void 0?void 0:u.style,F],onBlur:this.handleInputBlur,onFocus:j=>{this.handleInputFocus(j,2)},onInput:this.handleInput,onChange:this.handleChange,onScroll:this.handleTextAreaScroll})),this.showPlaceholder1?n("div",{class:`${a}-input__placeholder`,style:[this.placeholderStyle,F],key:"placeholder"},this.mergedPlaceholder[0]):null,this.autosize?n(Fr,{onResize:this.handleTextAreaMirrorResize},{default:()=>n("div",{ref:"textareaMirrorElRef",class:`${a}-input__textarea-mirror`,key:"mirror"})}):null)}}):n("div",{class:`${a}-input__input`},n("input",Object.assign({type:P==="password"&&this.mergedShowPasswordOn&&this.passwordVisible?"text":P},this.inputProps,{ref:"inputElRef",class:[`${a}-input__input-el`,(o=this.inputProps)===null||o===void 0?void 0:o.class],style:[this.textDecorationStyle[0],(s=this.inputProps)===null||s===void 0?void 0:s.style],tabindex:this.passivelyActivated&&!this.activated?-1:void 0,placeholder:this.mergedPlaceholder[0],disabled:this.mergedDisabled,maxlength:b?void 0:this.maxlength,minlength:b?void 0:this.minlength,value:Array.isArray(this.mergedValue)?this.mergedValue[0]:this.mergedValue,readonly:this.readonly,autofocus:this.autofocus,size:this.attrSize,onBlur:this.handleInputBlur,onFocus:h=>{this.handleInputFocus(h,0)},onInput:h=>{this.handleInput(h,0)},onChange:h=>{this.handleChange(h,0)}})),this.showPlaceholder1?n("div",{class:`${a}-input__placeholder`},n("span",null,this.mergedPlaceholder[0])):null,this.autosize?n("div",{class:`${a}-input__input-mirror`,key:"mirror",ref:"inputMirrorElRef"}," "):null),!this.pair&&ue(v.suffix,h=>h||this.clearable||this.showCount||this.mergedShowPasswordOn||this.loading!==void 0?n("div",{class:`${a}-input__suffix`},[ue(v["clear-icon-placeholder"],u=>(this.clearable||u)&&n(qe,{clsPrefix:a,show:this.showClearButton,onClear:this.handleClear},{placeholder:()=>u,icon:()=>{var S,F;return(F=(S=this.$slots)["clear-icon"])===null||F===void 0?void 0:F.call(S)}})),this.internalLoadingBeforeSuffix?null:h,this.loading!==void 0?n(Ur,{clsPrefix:a,loading:this.loading,showArrow:!1,showClear:!1,style:this.cssVars}):null,this.internalLoadingBeforeSuffix?h:null,this.showCount&&this.type!=="textarea"?n(to,null,{default:u=>{var S;return(S=v.count)===null||S===void 0?void 0:S.call(v,u)}}):null,this.mergedShowPasswordOn&&this.type==="password"?n("div",{class:`${a}-input__eye`,onMousedown:this.handlePasswordToggleMousedown,onClick:this.handlePasswordToggleClick},this.passwordVisible?xe(v["password-visible-icon"],()=>[n(Re,{clsPrefix:a},{default:()=>n(Wr,null)})]):xe(v["password-invisible-icon"],()=>[n(Re,{clsPrefix:a},{default:()=>n(Lr,null)})])):null]):null)),this.pair?n("span",{class:`${a}-input__separator`},xe(v.separator,()=>[this.separator])):null,this.pair?n("div",{class:`${a}-input-wrapper`},n("div",{class:`${a}-input__input`},n("input",{ref:"inputEl2Ref",type:this.type,class:`${a}-input__input-el`,tabindex:this.passivelyActivated&&!this.activated?-1:void 0,placeholder:this.mergedPlaceholder[1],disabled:this.mergedDisabled,maxlength:b?void 0:this.maxlength,minlength:b?void 0:this.minlength,value:Array.isArray(this.mergedValue)?this.mergedValue[1]:void 0,readonly:this.readonly,style:this.textDecorationStyle[1],onBlur:this.handleInputBlur,onFocus:h=>{this.handleInputFocus(h,1)},onInput:h=>{this.handleInput(h,1)},onChange:h=>{this.handleChange(h,1)}}),this.showPlaceholder2?n("div",{class:`${a}-input__placeholder`},n("span",null,this.mergedPlaceholder[1])):null),ue(v.suffix,h=>(this.clearable||h)&&n("div",{class:`${a}-input__suffix`},[this.clearable&&n(qe,{clsPrefix:a,show:this.showClearButton,onClear:this.handleClear},{icon:()=>{var u;return(u=v["clear-icon"])===null||u===void 0?void 0:u.call(v)},placeholder:()=>{var u;return(u=v["clear-icon-placeholder"])===null||u===void 0?void 0:u.call(v)}}),h]))):null,this.mergedBordered?n("div",{class:`${a}-input__border`}):null,this.mergedBordered?n("div",{class:`${a}-input__state-border`}):null,this.showCount&&P==="textarea"?n(to,null,{default:h=>{var u;const{renderCount:S}=this;return S?S(h):(u=v.count)===null||u===void 0?void 0:u.call(v,h)}}):null)}});function re(o){return ho(o,[255,255,255,.16])}function Be(o){return ho(o,[0,0,0,.12])}const et=lo("n-button-group"),ot=g([z("button",`
 ...
 align-items: center;
 justify-content: center;
 `,[no({top:"50%",originalTransform:"translateY(-50%)"})]),Gr()]),i("content",`
 display: flex;
 align-items: center;
 flex-wrap: nowrap;
 min-width: 0;
