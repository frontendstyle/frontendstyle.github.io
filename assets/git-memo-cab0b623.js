import{o,e as s,a3 as r,d as l,a1 as i,bx as m,i as p,h as a,A as d}from"./index-d4d1dfb2.js";const g={class:"markdown-body"},h=r(`<h2>Configuration</h2><p>Set the global config</p><pre><code class="language-shell">git config --global user.name &quot;[name]&quot;
...
</code></pre>`,27),_=[h],u={__name:"git-memo.content",setup(c,{expose:e}){return e({frontmatter:{}}),(n,b)=>(o(),s("div",g,_))}},f=l({__name:"git-memo",setup(c){i(t=>({"8cb22b3c":a(e).cardColor}));const e=m();return(t,n)=>(o(),s("div",null,[p(a(u))]))}});const C=d(f,[["__scopeId","data-v-c7dbeca3"]]);export{C as default};
